...
function renderEvidenceThumbnail(evidence, isImage) {
  const fallback = isImage
    ? `this.src='${API}/evidence/${evidence.id}/file'`
    : "this.hidden=true";
  return `<img src="${API}/evidence/${evidence.id}/thumbnail" loading="lazy" decoding="async" alt=""
